...
import { deckIds, decks } from '../js/data/decks.js?v=0.13.11';
import { superstars } from '../js/data/superstars.js?v=0.13.11';
import { MatchEngine } from '../js/engine/MatchEngine.js?v=0.13.11';
import { counterEligibility } from '../js/engine/rules.js?v=0.13.11';
import { createProfile, migrateProfile, totalOwnedCopies, PROFILE_VERSION } from '../js/data/profile.js?v=0.13.11';
...
test('v0.13.2 every authored 60-page deck starts with exactly one Once Too Often outside Lead Off 5',()=>{
  assert.equal(Object.keys(deckIds).length,50);
