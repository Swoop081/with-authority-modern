...
import { deckIds, decks } from '../js/data/decks.js?v=0.13.93';
...
import { createProfile, migrateProfile, totalOwnedCopies, PROFILE_VERSION } from '../js/data/profile.js?v=0.13.93';
