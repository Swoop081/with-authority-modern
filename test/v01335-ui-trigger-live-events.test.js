...
import { cpuDecision } from '../js/ai/WrestlingAI.js?v=0.13.36';
import { allGameplayCards } from '../js/data/content.js?v=0.13.36';
import { collectionCards } from '../js/data/collection.js?v=0.13.36';
import { reconstructCurrentPlayPile } from '../js/ui/play-pile.js?v=0.13.36';
...
import { activeLiveEventTowers, LIVE_EVENT_WIN_UP } from '../js/data/live-events.js?v=0.13.36';
import { isPlayerVisibleSuperstar } from '../js/data/release.js?v=0.13.36';
import { layeredCardArtFor, finishedCardArtFor } from '../js/data/artwork.js?v=0.13.36';
