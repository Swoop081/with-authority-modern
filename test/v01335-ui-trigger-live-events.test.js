...
import { cpuDecision } from '../js/ai/WrestlingAI.js?v=0.13.61';
import { allGameplayCards } from '../js/data/content.js?v=0.13.61';
import { collectionCards } from '../js/data/collection.js?v=0.13.61';
import { reconstructCurrentPlayPile } from '../js/ui/play-pile.js?v=0.13.61';
...
import { activeLiveEventTowers, LIVE_EVENT_WIN_UP } from '../js/data/live-events.js?v=0.13.61';
import { isPlayerVisibleSuperstar } from '../js/data/release.js?v=0.13.61';
import { layeredCardArtFor, finishedCardArtFor } from '../js/data/artwork.js?v=0.13.61';
