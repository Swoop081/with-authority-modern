...
import { cpuDecision } from '../js/ai/WrestlingAI.js?v=0.13.48';
import { allGameplayCards } from '../js/data/content.js?v=0.13.48';
import { collectionCards } from '../js/data/collection.js?v=0.13.48';
import { reconstructCurrentPlayPile } from '../js/ui/play-pile.js?v=0.13.48';
...
import { activeLiveEventTowers, LIVE_EVENT_WIN_UP } from '../js/data/live-events.js?v=0.13.48';
import { isPlayerVisibleSuperstar } from '../js/data/release.js?v=0.13.48';
import { layeredCardArtFor, finishedCardArtFor } from '../js/data/artwork.js?v=0.13.48';
...
test('v0.13.35 layered fronts are attempted for Superstars before the standard front fallback',()=>{
...
test('v0.13.35 UI locks the screenshot polish and Play Pile dedupe behavior',()=>{
  ...
  assert.match(app,/pack-summary-actions two-button-row/);
