...
import { reconstructCurrentPlayPile } from '../js/ui/play-pile.js?v=0.13.74';
...
import { activeLiveEventTowers, LIVE_EVENT_WIN_UP } from '../js/data/live-events.js?v=0.13.74';
import { isPlayerVisibleSuperstar } from '../js/data/release.js?v=0.13.74';
import { layeredCardArtFor, finishedCardArtFor } from '../js/data/artwork.js?v=0.13.74';
