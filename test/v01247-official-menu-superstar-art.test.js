...
test.skip('v0.12.48 keeps the exact 12-render WWE menu cast separate from collectible-card artwork — superseded by v0.13.96 flat asset paths', () => {
...
test.skip('v0.12.48 dedicated menu-art folder contains only the requested 12 Superstar renders — superseded by v0.13.96 flat asset paths', () => {
