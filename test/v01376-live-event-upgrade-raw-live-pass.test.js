...
import { activeLiveEventTowers, startLiveEventTower, RAW_LIVE_EVENT } from '../js/data/live-events.js?v=0.13.95';
import { counterEligibility } from '../js/engine/rules.js?v=0.13.95';
