...
import { createProfile } from '../js/data/profile.js?v=0.13.93';
...
import { activeLiveEventTowers, startLiveEventTower, RAW_LIVE_EVENT } from '../js/data/live-events.js?v=0.13.93';
import { counterEligibility } from '../js/engine/rules.js?v=0.13.93';
