...
} from '../js/data/profile.js?v=0.13.48';
...
} from '../js/data/deck-builder.js?v=0.13.48';
import { findPackUpgrades, applyUpgrade } from '../js/data/deck-assistant.js?v=0.13.48';
import { SUPERSTAR_CHASE_CHANCE, SUPERSTAR_PITY_PACKS } from '../js/data/boosters.js?v=0.13.48';
