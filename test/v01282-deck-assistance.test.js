...
import { createProfile, addOwnedCard } from "../js/data/profile.js?v=0.12.87";
...
import { validateDeckDraft, selectedEntranceId, cardEligibilityForSuperstar } from "../js/data/deck-builder.js?v=0.12.87";
import { findPackUpgrades, applyUpgrade, buildPlayableDeck } from "../js/data/deck-assistant.js?v=0.12.87";
