...
import { createProfile, migrateProfile } from "../js/data/profile.js?v=0.12.87";
import { CAREER_ACHIEVEMENTS, recordCareerMatch, refreshCareerAchievements } from "../js/data/career.js?v=0.12.87";
import { collectionCards } from "../js/data/collection.js?v=0.12.87";
import { decks } from "../js/data/decks.js?v=0.12.87";
import { tierReward } from "../js/data/seasons.js?v=0.12.87";
