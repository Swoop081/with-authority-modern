...
import { createProfile, migrateProfile } from "../js/data/profile.js?v=0.13.9";
import { CAREER_ACHIEVEMENTS, recordCareerMatch, refreshCareerAchievements } from "../js/data/career.js?v=0.13.9";
