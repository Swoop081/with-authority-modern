...
import { createProfile, migrateProfile } from "../js/data/profile.js?v=0.14.04";
import { CAREER_ACHIEVEMENTS, recordCareerMatch, refreshCareerAchievements } from "../js/data/career.js?v=0.14.04";
