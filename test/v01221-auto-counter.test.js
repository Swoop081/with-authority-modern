...
import { autoCounterCost, autoCounterEligibility, counterEligibility } from '../js/engine/rules.js?v=0.12.64';
import { cpuDecision } from '../js/ai/WrestlingAI.js?v=0.12.64';
