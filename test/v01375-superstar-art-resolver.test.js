...
import { layeredCardArtFor, superstarCardArtFor, superstarHeadshotFor } from '../js/data/artwork.js?v=0.13.93';
...
test('v0.13.75 Superstar layered fronts use the exact Card Studio superstarId filename', () => {
...
test('v0.13.75 every roster Superstar resolves Card Studio flat-front and HUD headshot candidate paths without an old registry entry', () => {
...
test('v0.13.75 clean packager retains layered Superstar and headshot asset trees', () => {
