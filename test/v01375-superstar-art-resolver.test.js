...
import { layeredCardArtFor, superstarCardArtFor, superstarHeadshotFor } from '../js/data/artwork.js?v=0.13.95';
...
test.skip('v0.13.75 Superstar layered fronts use the exact Card Studio superstarId filename — superseded by v0.13.95 flat asset paths', () => {
...
test.skip('v0.13.75 every roster Superstar resolves Card Studio flat-front and HUD headshot candidate paths without an old registry entry — superseded by v0.13.95 flat asset paths', () => {
...
test.skip('v0.13.75 clean packager retains layered Superstar and headshot asset trees — superseded by v0.13.95 flat asset paths', () => {
