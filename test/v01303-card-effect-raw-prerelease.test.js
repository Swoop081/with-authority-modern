...
import { PRE_RELEASE_TEST_SET_IDS, isInternalTestSetId, isPlayerReleasedSetId, isPlayerVisibleSuperstar, isUnreleasedSetId } from '../js/data/release.js?v=0.13.32';
import { boosterEligible } from '../js/data/boosters.js?v=0.13.32';
import { filterAndSortCatalogue, defaultCatalogueFilters } from '../js/data/catalogue.js?v=0.13.32';
...
test('v0.13.3 RAW Series 1 is in internal certification scope but remains completely unreleased player-facing', () => {
  ...
  assert.equal(rawCards.length, 37);
