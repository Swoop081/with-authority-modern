...
import { PRE_RELEASE_TEST_SET_IDS, isInternalTestSetId, isPlayerReleasedSetId, isPlayerVisibleSuperstar, isUnreleasedSetId } from '../js/data/release.js?v=0.13.97';
...
import { moveEligibility } from '../js/engine/rules.js?v=0.13.97';
