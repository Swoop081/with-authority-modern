...
import { WEEKLY_LIVE_EVENTS, LIVE_EVENT_LENGTH, LIVE_EVENT_WIN_UP, LIVE_EVENT_CLEAR_BOOSTERS, liveEventRotation, liveEventStage, weeklyLiveEventState, startWeeklyLiveEvent, currentWeeklyLiveEventOpponent, recordWeeklyLiveEventMatch } from "../js/data/live-events.js?v=0.13.71";
import { superstars } from "../js/data/superstars.js?v=0.13.71";
import { decks } from "../js/data/decks.js?v=0.13.71";
import { isLaunchLiveSetId } from "../js/data/release.js?v=0.13.71";
...
test("v0.12.81 Play menu still exposes Live Events and pack reveals can continue after duplicate conversion", () => {
  ...
  assert.match(app, /boosted-odds .*Super Pack has been awarded/);
});
