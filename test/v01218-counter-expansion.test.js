...
import { COUNTER_STATES, SUBMISSION_TARGETS } from '../js/data/counter-states.js?v=0.14.04';
import { canCounter, counterEligibility } from '../js/engine/rules.js?v=0.14.04';
