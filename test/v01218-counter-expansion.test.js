...
import { COUNTER_STATES, SUBMISSION_TARGETS } from '../js/data/counter-states.js?v=0.12.54';
import { canCounter, counterEligibility } from '../js/engine/rules.js?v=0.12.54';
import { createProfile, migrateProfile, PROFILE_VERSION } from '../js/data/profile.js?v=0.12.54';
