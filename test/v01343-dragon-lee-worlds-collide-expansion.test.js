...
import { canPlaySpecial, moveEligibility } from '../js/engine/rules.js?v=0.13.48';
import { CARD_NUMBER_BY_ID, CARD_IDS_BY_SET } from '../js/data/card-number-manifest.js?v=0.13.48';
import { PRE_RELEASE_TEST_SET_IDS } from '../js/data/release.js?v=0.13.48';

const byId=id=>allGameplayCards.find(c=>c.id===id);
const star=id=>Object.values(superstars).find(s=>s.id===id);
const rng=()=>0.99;

test('v0.13.43 Dragon Lee WC1 package is locked with no new shared move',()=>{
