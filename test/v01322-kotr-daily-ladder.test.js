...
import { createProfile } from '../js/data/profile.js?v=0.13.32';
import { superstars } from '../js/data/superstars.js?v=0.13.32';
import { LADDER_LENGTH, LADDER_LIVES, ladderState, startLadderRun, recordLadderMatch } from '../js/data/ladder.js?v=0.13.32';
import { KING_OF_THE_RING_ROUNDS, kingOfTheRingState, startKingOfTheRing, recordKingOfTheRingMatch } from '../js/data/king-of-the-ring.js?v=0.13.32';
import { CAREER_MODES } from '../js/data/career.js?v=0.13.32';
