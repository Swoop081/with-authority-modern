...
import { SEASON_TIER_COUNT, MAX_SEASON_XP, tierReward, FINAL_BOSS_TIER_REWARDS } from '../js/data/seasons.js?v=0.13.19';
import { LAUNCH_LIVE_SET_IDS } from '../js/data/release.js?v=0.13.19';
