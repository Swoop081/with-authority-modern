...
test('v0.13.95 stores every image in one flat assets/images directory',()=>{
...
test('v0.13.95 canonical card and headshot resolvers use flat filenames',()=>{
...
test('v0.13.95 recovered known card art and headshots are physically packaged',()=>{
...
test('v0.13.95 Welcome screen owns the viewport without legacy chrome top gap',()=>{
