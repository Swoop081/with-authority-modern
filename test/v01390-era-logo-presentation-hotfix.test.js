...
test('v0.13.90 Golden Era card logo is the existing WWF block without invented GOLDEN ERA text',()=>{
...
test('v0.13.90 Attitude Era card-art-studio logo draw box is exactly doubled',()=>{
...
test('v0.13.90 local-file Card Art Studio uses corrected Golden logo override',()=>{
  const studio=read('js/tools/card-art-studio.js');
