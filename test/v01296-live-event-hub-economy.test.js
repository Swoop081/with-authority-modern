...
import { activeLiveEventTowers, liveEventTowerState, startLiveEventTower, currentLiveEventTowerOpponent, recordLiveEventTowerMatch, LIVE_EVENT_LENGTH } from '../js/data/live-events.js?v=0.13.94';
import { createProfile } from '../js/data/profile.js?v=0.13.94';
import { STORE_SUPERSTAR_PRICE } from '../js/data/store.js?v=0.13.94';
import { superstars } from '../js/data/superstars.js?v=0.13.94';
import { isLaunchLiveSetId } from '../js/data/release.js?v=0.13.94';
