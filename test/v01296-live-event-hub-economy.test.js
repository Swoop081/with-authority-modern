...
import { activeLiveEventTowers, liveEventTowerState, startLiveEventTower, currentLiveEventTowerOpponent, recordLiveEventTowerMatch, LIVE_EVENT_LENGTH } from '../js/data/live-events.js?v=0.14.04';
import { createProfile } from '../js/data/profile.js?v=0.14.04';
import { STORE_SUPERSTAR_PRICE } from '../js/data/store.js?v=0.14.04';
