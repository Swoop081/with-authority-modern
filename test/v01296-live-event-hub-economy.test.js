...
import { activeLiveEventTowers, liveEventTowerState, startLiveEventTower, currentLiveEventTowerOpponent, recordLiveEventTowerMatch, LIVE_EVENT_LENGTH } from '../js/data/live-events.js?v=0.13.18';
import { createProfile } from '../js/data/profile.js?v=0.13.18';
import { STORE_SUPERSTAR_PRICE } from '../js/data/store.js?v=0.13.18';
