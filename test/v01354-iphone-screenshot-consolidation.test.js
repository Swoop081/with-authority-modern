...
import { COLLECTION_MILESTONES, FOIL_MILESTONES } from '../js/data/set-progression.js?v=0.13.75';
import { activeLiveEventTowers } from '../js/data/live-events.js?v=0.13.75';
