...
import { cpuDecision } from '../js/ai/WrestlingAI.js?v=0.13.12';
import { submissionThreshold } from '../js/engine/rules.js?v=0.13.12';
import { healthOnlyPinChance } from '../js/engine/health.js?v=0.13.12';
