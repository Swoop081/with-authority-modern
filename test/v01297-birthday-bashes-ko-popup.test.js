...
import { BIRTHDAY_TOWERS, RELEASED_BIRTHDAY_ROSTER_IDS, activeLiveEventTowers, startLiveEventTower } from '../js/data/live-events.js?v=0.13.37';
...
import { isLaunchLiveSetId } from '../js/data/release.js?v=0.13.37';
