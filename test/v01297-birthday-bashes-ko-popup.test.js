...
import { BIRTHDAY_TOWERS, RELEASED_BIRTHDAY_ROSTER_IDS, activeLiveEventTowers, startLiveEventTower } from '../js/data/live-events.js?v=0.13.77';
...
import { isLaunchLiveSetId } from '../js/data/release.js?v=0.13.77';
...
test('v0.12.97 Birthday Bash calendar contains exactly the the authored 24-Superstar birthday roster',()=>{
