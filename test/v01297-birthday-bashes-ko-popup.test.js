...
import { BIRTHDAY_TOWERS, RELEASED_BIRTHDAY_ROSTER_IDS, activeLiveEventTowers, startLiveEventTower } from '../js/data/live-events.js?v=0.13.22';
...
import { isLaunchLiveSetId } from '../js/data/release.js?v=0.13.22';
import { createProfile } from '../js/data/profile.js?v=0.13.22';
