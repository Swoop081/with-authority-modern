...
import { BIRTHDAY_TOWERS, RELEASED_BIRTHDAY_ROSTER_IDS, activeLiveEventTowers, startLiveEventTower } from '../js/data/live-events.js?v=0.13.48';
...
import { isLaunchLiveSetId } from '../js/data/release.js?v=0.13.48';
...
test('v0.12.97 Birthday Bash calendar contains exactly the currently released 24-Superstar launch roster',()=>{
  assert.equal(BIRTHDAY_TOWERS.length,24);
