...
import { DECK_LAB_CATEGORIES, categoryForCard } from '../js/data/deck-builder.js?v=0.14.03';
...
import { canPlayAction, canPlayPinEscape } from '../js/engine/rules.js?v=0.14.03';
