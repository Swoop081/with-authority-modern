...
import { createProfile, addOwnedCard, cardOwnershipCap } from '../js/data/profile.js?v=0.14.04';
import { collectionCards } from '../js/data/collection.js?v=0.14.04';
import { decks } from '../js/data/decks.js?v=0.14.04';
import { applyFoilGameplay, foilDamageBonusFor } from '../js/data/foil.js?v=0.14.04';
import { addCardToDraft, canAddCard } from '../js/data/deck-builder.js?v=0.14.04';
import { buildPlayableDeck, findPackUpgrades } from '../js/data/deck-assistant.js?v=0.14.04';
