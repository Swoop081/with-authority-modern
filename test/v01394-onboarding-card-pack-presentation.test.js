...
test('v0.13.95 starter choice renders actual Normal Superstar cards for Punk and Roman', () => {
...
test('v0.13.95 Welcome era choice renders the five physical set packs as selectors', () => {
