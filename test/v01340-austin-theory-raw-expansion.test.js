...
import { autoCounterEligibility, canPlaySpecial, counterEligibility, moveEligibility } from '../js/engine/rules.js?v=0.13.74';
import { legalForSuperstar } from '../js/data/deck-builder.js?v=0.13.74';
