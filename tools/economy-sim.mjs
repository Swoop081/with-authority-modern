...
const SET_IDS = ["summerslam-series-1", "hall-of-fame-series-1"];
...
function simulateSet(setId) {
  ...
  for(let t=0;t<TRIALS;t++){
    const p=createProfile(t%2?"roman-reigns":"cm-punk"); grantBooster(p,MAX_PACKS+5,setId); const rng=rngFor(100003+t*7919+(setId==="hall-of-fame-series-1"?55555:0)); const hit={};
