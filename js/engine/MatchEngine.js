import { PHASES } from "./constants.js?v=0.11.37";
import { clone } from "./utils.js?v=0.11.37";
import { entranceForSuperstar } from "../data/entrances.js?v=0.11.37";
import {
  canPlayMomentum,
  canPlayEntrance,
  canPlayAction,
