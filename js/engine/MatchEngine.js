import { PHASES } from "./constants.js?v=0.11.43";
import { clone } from "./utils.js?v=0.11.43";
import { entranceForSuperstar } from "../data/entrances.js?v=0.11.43";
import {
  canPlayMomentum,
  canPlayEntrance,
  canPlayAction,
