import { PHASES } from "./constants.js?v=0.11.40";
import { clone } from "./utils.js?v=0.11.40";
import { entranceForSuperstar } from "../data/entrances.js?v=0.11.40";
import {
  canPlayMomentum,
  canPlayEntrance,
  canPlayAction,
