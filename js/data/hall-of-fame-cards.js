...
export const hallCards = {
  ...
  hoganEntrance: entrance("hof1-entrance-hulk-hogan", "Real American", "hulk-hogan", "Pre-Match — Begin with +1 Strength Momentum and +1 Adrenaline.", [{ type: "gainMomentum", method: "strength", amount: 1 }, { type: "gainMomentum", method: "attitude", amount: 1 }]),
  andreEntrance: entrance("hof1-entrance-andre-the-giant", "The Eighth Wonder", "andre-the-giant", "Pre-Match — Begin with +1 Strength Momentum and +1 Adrenaline.", [{ type: "gainMomentum", method: "strength", amount: 1 }, { type: "gainMomentum", method: "attitude", amount: 1 }]),
  savageEntrance: entrance("hof1-entrance-randy-savage", "Pomp and Circumstance", "randy-savage", "Pre-Match — Begin with +1 Technical Momentum and +1 Adrenaline.", [{ type: "gainMomentum", method: "technical", amount: 1 }, { type: "gainMomentum", method: "attitude", amount: 1 }]),
  warriorEntrance: entrance("hof1-entrance-ultimate-warrior", "Warrior's Charge", "ultimate-warrior", "Pre-Match — Begin with +1 Agility Momentum and +1 Adrenaline.", [{ type: "gainMomentum", method: "agility", amount: 1 }, { type: "gainMomentum", method: "attitude", amount: 1 }]),
  austinEntrance: entrance("hof1-entrance-stone-cold", "Glass Shatters", "stone-cold-steve-austin", "Pre-Match — Begin with +1 Strike Momentum and +1 Adrenaline.", [{ type: "gainMomentum", method: "strike", amount: 1 }, { type: "gainMomentum", method: "attitude", amount: 1 }]),
  undertakerEntrance: entrance("hof1-entrance-undertaker", "Rest in Peace", "the-undertaker", "Pre-Match — Begin with +1 Strength Momentum and +1 Adrenaline.", [{ type: "gainMomentum", method: "strength", amount: 1 }, { type: "gainMomentum", method: "attitude", amount: 1 }]),
  mankindEntrance: entrance("hof1-entrance-mankind", "Boiler Room Dweller", "mankind", "Pre-Match — Begin with +1 Technical Momentum and +1 Adrenaline.", [{ type: "gainMomentum", method: "technical", amount: 1 }, { type: "gainMomentum", method: "attitude", amount: 1 }]),
  kaneEntrance: entrance("hof1-entrance-kane", "Hellfire and Brimstone", "kane", "Pre-Match — Begin with +1 Agility Momentum and +1 Adrenaline.", [{ type: "gainMomentum", method: "agility", amount: 1 }, { type: "gainMomentum", method: "attitude", amount: 1 }]),
  ...
  bobbyHeenan: manager("hof1-manager-bobby-heenan", "Bobby \"The Brain\" Heenan", ["andre-the-giant"], "THE BRAIN — Once per match, after one of your non-Finisher Moves is successfully Countered, regain Control and draw 1 page.", "MANUAL", [], {}, { managerChoice: "heenan" }),
  missElizabeth: manager("hof1-manager-miss-elizabeth", "Miss Elizabeth", ["randy-savage"], "FIRST LADY OF WRESTLING — Once per match after Savage loses Control, draw 1 page and gain +1 Adrenaline.", "MANUAL", [], {}, { managerChoice: "elizabeth" }),
  ...
  andreSpecial: special("hof1-andre-unstoppable-giant","Nobody Slams André",{superstarId:"andre-the-giant",andreFinalSpecial:true,abilityText:"Once per match, when an opponent's Strength Move would ground André, André remains Standing and gains +1 Adrenaline. Damage still applies."}),
  ...
  andreGiantSplash: move("hof1-andre-giant-splash","Sitdown Splash",{superstarId:"andre-the-giant",method:"strength",cost:9,requirements:{},damage:16,requiresPosture:"on-mat",finisher:true,pinBonus:4}),

  hoganSpecial: special("hof1-hogan-hulking-up","Hulk Up",{superstarId:"hulk-hogan",hoganSpecial:true,abilityText:"Once per match when Hogan gains Control at 50% HP or less: clear Stun, gain +2 Adrenaline, and Hogan's next Hogan's Big Boot this Control sequence cannot be Countered by a Move."}),
  ...
  hoganBigBootReviewed: move("hof1-hogan-big-boot-reviewed","Hogan's Big Boot",{superstarId:"hulk-hogan",moveFamily:"big-boot",method:"strike",cost:6,requirements:{strike:2},damage:9,trademark:true,setOpponentPosture:"on-mat",effectText:"On connect: search your Playbook for Atomic Leg Drop and draw it.",onConnect:[{type:"searchDeck",cardId:"hof1-hogan-atomic-leg-drop-reviewed"}]}),
  ...
  hoganAtomicLegDropReviewed: move("hof1-hogan-atomic-leg-drop-reviewed","Atomic Leg Drop",{superstarId:"hulk-hogan",moveFamily:"leg-drop",method:"strike",cost:9,requirements:{},damage:16,requiresPosture:"on-mat",finisher:true,pinBonus:3}),
  ...
  savageSpecial: special("hof1-savage-cream","Oh Yeah!",{superstarId:"randy-savage",savageFinalSpecial:true,abilityText:"Once per match after Savage successfully Counters a Move, his next Agility Move during that Control sequence costs 2 less."}),
  ...
  savageFlyingElbowReviewed: move("hof1-savage-flying-elbow-reviewed","Flying Elbow Drop",{superstarId:"randy-savage",method:"agility",cost:9,requirements:{},damage:16,requiresPosture:"on-mat",finisher:true,pinBonus:3}),

  warriorSpecial: special("hof1-warrior-comeback","Shake the Ropes",{superstarId:"ultimate-warrior",warriorSpecial:true,abilityText:"Once per match after Warrior loses Control at 50% HP or less, gain +2 Adrenaline. The next time Warrior gains Control, clear Stun."}),
  ...
  warriorPressReviewed: move("hof1-warrior-gorilla-press-reviewed","Gorilla Press Slam",{superstarId:"ultimate-warrior",method:"strength",cost:7,requirements:{strength:3},damage:11,trademark:true,setOpponentPosture:"on-mat",effectText:"On connect: search your Playbook for Warrior Splash and draw it.",onConnect:[{type:"searchDeck",cardId:"hof1-warrior-splash-reviewed"}]}),
  warriorSplashReviewed: move("hof1-warrior-splash-reviewed","Warrior Splash",{superstarId:"ultimate-warrior",method:"strength",cost:9,requirements:{},damage:16,requiresPosture:"on-mat",finisher:true,pinBonus:3}),
  ...
  austinSpecial: special("hof1-austin-316","Austin 3:16",{superstarId:"stone-cold-steve-austin",austinSpecial:true,abilityText:"Once per match after Austin successfully Counters a Move, search your Playbook for a Strike Move costing 5 or less."}),
  ...
  austinLouTheszReviewed: move("hof1-austin-lou-thesz-reviewed","Lou Thesz Press",{superstarId:"stone-cold-steve-austin",moveFamily:"thesz-press",method:"strike",cost:5,requirements:{strike:1,strength:1},damage:8,trademark:true,setOpponentPosture:"on-mat"}),
  austinKickReviewed: move("hof1-austin-kick-reviewed","Kick to the Gut",{superstarId:"stone-cold-steve-austin",moveFamily:"kick-to-gut",method:"strike",cost:3,requirements:{strike:1},damage:4,effectText:"If Austin connects with this, Stone Cold Stunner cannot be Countered on Austin's immediately following turn."}),
  austinStunnerReviewed: move("hof1-austin-stunner-reviewed","Stone Cold Stunner",{superstarId:"stone-cold-steve-austin",moveFamily:"stunner",method:"strike",cost:9,requirements:{},damage:17,setOpponentPosture:"on-mat",finisher:true,stunTurns:1}),
  ...
  takerSpecial: special("hof1-taker-sit-up","Sit Up",{superstarId:"the-undertaker",takerSpecial:true,abilityText:"Once per match after Undertaker kicks out of a Pin, immediately take Control and gain +1 Adrenaline."}),
  takerOldSchoolReviewed: move("hof1-taker-old-school-reviewed","Old School",{superstarId:"the-undertaker",method:"strike",cost:5,requirements:{technical:1,strike:1},damage:8,trademark:true,setOpponentPosture:"on-mat",effectText:"On connect: opponent ditches 1 page.",onConnect:[{type:"discard",target:"opponent",amount:1}]}),
  takerSnakeEyesReviewed: move("hof1-taker-snake-eyes-reviewed","Snake Eyes",{superstarId:"the-undertaker",method:"strength",cost:5,requirements:{strength:2},damage:8,effectText:"On connect: Undertaker's next Running Big Boot during this Control sequence gets +2 Damage."}),
  takerChokeslamReviewed: move("hof1-taker-chokeslam-reviewed","Chokeslam",{superstarId:"the-undertaker",moveFamily:"chokeslam",method:"strength",cost:5,requirements:{strength:2},damage:9,setOpponentPosture:"on-mat"}),
  takerTombstoneReviewed: move("hof1-taker-tombstone-reviewed","Tombstone Piledriver",{superstarId:"the-undertaker",moveFamily:"tombstone",method:"strength",cost:10,requirements:{},damage:17,setOpponentPosture:"on-mat",finisher:true,stunTurns:1}),
  ...
  kaneSpecial: special("hof1-kane-through-hellfire","Rise From the Flames",{superstarId:"kane",kaneFinalSpecial:true,abilityText:"Once per match, when Kane would become Stunned, ignore that Stun and gain +1 Adrenaline."}),
  ...
  kaneFlyingReviewed: move("hof1-kane-flying-reviewed","Flying Clothesline",{superstarId:"kane",moveFamily:"flying-clothesline",method:"agility",cost:5,requirements:{agility:1,strike:1},damage:8,setOpponentPosture:"on-mat"}),
  kaneChokeLift: move("hof1-kane-choke-lift","Two-Handed Choke Lift",{superstarId:"kane",method:"strength",cost:5,requirements:{strength:2},damage:8,stunTurns:1,effectText:"On connect: Kane's next Chokeslam From Hell during this Control sequence gets +1 Damage."}),
  kaneChokeslamReviewed: move("hof1-kane-chokeslam-reviewed","Chokeslam From Hell",{superstarId:"kane",moveFamily:"chokeslam",method:"strength",cost:7,requirements:{strength:3},damage:12,trademark:true,setOpponentPosture:"on-mat",stunTurns:1}),
  kaneTombstoneReviewed: move("hof1-kane-tombstone-reviewed","Tombstone Piledriver",{superstarId:"kane",moveFamily:"tombstone",method:"strength",cost:10,requirements:{},damage:17,setOpponentPosture:"on-mat",finisher:true,stunTurns:1}),
  ...
  mankindSpecial: special("hof1-mankind-bang-bang","Mr. Socko",{superstarId:"mankind",mankindSockoFinal:true,abilityText:"Once per match when Mankind gains Control while the opponent is grounded: draw 1 page; his next Mandible Claw this Control sequence costs 2 less."}),
  ...
  mankindDoubleArmReviewed: move("hof1-mankind-double-arm-reviewed","Double-Arm DDT",{superstarId:"mankind",method:"technical",cost:7,requirements:{technical:1,strike:1},damage:11,trademark:true,setOpponentPosture:"on-mat",pinBonus:3}),
  mankindClawReviewed: move("hof1-mankind-claw-reviewed","Mandible Claw",{superstarId:"mankind",method:"technical",cost:9,requirements:{},damage:4,requiresPosture:"on-mat",submission:{bodyPart:"head",damage:6},finisher:true}),
