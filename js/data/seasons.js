import { unlockSuperstar, addOwnedCard, addUniversePoints } from "./profile.js?v=0.12.34";
import { decks } from "./decks.js?v=0.12.34";
import { superstars } from "./superstars.js?v=0.12.34";
...
export const MATCH_XP = { win: 25, loss: 5 };
