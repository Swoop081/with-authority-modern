...
import { sets } from "./sets.js?v=0.11.73";
import { allGameplayCards } from "./content.js?v=0.11.73";
import { CARD_NUMBER_MANIFEST, CARD_NUMBER_BY_ID, CARD_IDS_BY_SET } from "./card-number-manifest.js?v=0.11.73";
