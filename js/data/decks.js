...
export const decks = {
  ...
  "paige": reviewedDeck(
    ...
    [
      copies(M.technical, 5), copies(M.strike, 3), copies(hallCards.forearm, 2), copies(evolutionCards.armDrag, 2), copies(evolutionCards.paigeSuperkick, 2), copies(M.agility, 2), copies(evolutionCards.paigeSpecial, 1), copies(evolutionCards.paigeThinkAgain, 1), copies(evolutionCards.paigeRopeKnees, 2), copies(evolutionCards.paigeTurner, 2), copies(evolutionCards.ramPaige, 3), copies(evolutionCards.pto, 3), copies(evolutionCards.ddt, 2), copies(cards.neckbreaker, 2), copies(evolutionCards.snapSuplex, 2), copies(evolutionCards.bostonCrab, 2), copies(evolutionCards.dodge, 3), copies(evolutionCards.duck, 3), copies(evolutionCards.europeanUppercut, 3), copies(evolutionCards.legSweep, 3), copies(evolutionCards.crossface, 2)
    ]
  ),
