import { moveEligibility, counterEligibility, autoCounterEligibility, canPlaySpecial, canPlayMomentum, canPlayAction, canPlaySupport, canPlayManager, canAttemptPin, submissionThreshold } from "../engine/rules.js?v=0.13.32";
import { healthRatio, healthZone, healthOnlyPinChance } from "../engine/health.js?v=0.13.32";
