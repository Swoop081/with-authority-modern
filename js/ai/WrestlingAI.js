import { canPlayMomentum, canPlayAction, canPlaySupport, canPlayManager, moveEligibility, canCounter, canAttemptPin, canPlayPinEscape, pinChancePercent, submissionThreshold, canReturnToRing, canFollowOutside } from "../engine/rules.js";
import { totalMomentum } from "../engine/utils.js";
import { isOffensiveMove } from "../data/move-types.js";
