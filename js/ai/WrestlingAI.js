import { moveEligibility, counterEligibility, canPlaySpecial, canPlayMomentum, canAttemptPin } from "../engine/rules.js";
...
export function cpuDecision(game,pid="p2"){
 ...
 if(s.phase==="ACTION"){
   const def=s.players[pid==="p1"?"p2":"p1"];if(canAttemptPin(s,pid).legal&&def.hp<=def.maxHp*.5)return{type:"pin"};
