...
import { collectionCards } from "./collection.js?v=0.12.55";
import { superstars } from "./superstars.js?v=0.12.55";
import { evaluateDeckHealth, deckBucket } from "./deck-health.js?v=0.12.55";
import { isPlayerReleasedSetId } from "./release.js?v=0.12.55";
